...
from gen import genPrimer

flag = "Aero{e5767426d19e0f4bc4e171e0ba6d519ccad5a8decdf81a70b4f5ddb202441a09}"
...
def main():
    ...
    for i in range(0, 100):
        ...
        (text, res) = genPrimer(randint(4, 6))

        ret = "t=>[0;1]\n"
        for x in A.txt_to_form(text):  # A.txt_to_form(text):
            ret += (f"f(t) = ({x[0]}; {x[1]})\n")
